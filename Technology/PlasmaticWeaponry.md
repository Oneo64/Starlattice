...
#### Long-range Laser Projector
 - **Type:** Mounted Turret
 - **Projectile:** Laser
 - **Penetration per Second:** 4.5 centimetres (for fresarmanite plating), 6 centimetres (for typical steel), 30 centimetres (for civilian concrete, but the total performance range is 10 to 40 centimetres)
